export const Hero = () => {
    return (
        <div className="lg:pt-16 lg:pb-16 flex justify-center flex-row flex-wrap pt-4 pb-4 items-center gap-20">
            <div>
                <img src={require("../icons/awsdeveloper.png")} alt=""/>
            </div>
            <div className="flex flex-row flex-wrap justify-center">
                <img className="w-[320px] rounded-sm shadow-xl" src={require('../images/grandteton.JPEG')} alt="" />
