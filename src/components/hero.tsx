    ...
    <div className="bg-slate-400 rounded-lg m-2">
      <div className="flex flex-row flex-wrap justify-center m-2 min-h-[532px]">
        <div className="self-start m-2">
          <img
            className="mt-4 rounded-lg shadow-xl h-[400px] border-black border-solid border-2"
            src={require("../images/grandteton.JPEG")}
            alt=""
          />
        </div>

        <div className="flex-1 md:ml-2 lg:ml-4 flex flex-col flex-wrap justify-between rounded-lg max-w-[1/3] min-w-[333px] m-2">
          <div className="lg:px-8 text flex-1">
